  ...
  <v-container fluid class="pa-0">
    <v-row align="start" no-gutters>
      <v-col cols="12">
        ...
        <section class="mt-15">
          <div class="tw-relative">
            ...
            >
              ...
              >
              <span>
                <v-btn tile color="secondary" height="64" width="224" depressed>
        ...
        <section class="mt-15">
          <h3 class="tw-font-extrabold tw-text-5xl my-5 text-center">
            Latest Blogs
          </h3>
          ...
          <div class="d-flex flex-wrap align-center justify-center">
            ...
            >
              ...
              <v-card-text style="color: black" class="tw-font-normal">
                Morbi cursus libero at odio elementum consectetur. Vestibulum
                eleifed eros euismod rhoncus fringilla. Phasellus venen...
              </v-card-text>
